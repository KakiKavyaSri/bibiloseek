...
label_username.grid(row=0, column=0, padx=20, pady=10, sticky=tk.W)
...
label_password.grid(row=1, column=0, padx=20, pady=10, sticky=tk.W)

entry_password = tk.Entry(root, show="*", font=("Helvetica", 20))
entry_password.grid(row=1, column=1, padx=20, pady=10)

# Create a login button
login_button = tk.Button(root, text="Login", font=("Helvetica", 14), command=validate_login)
